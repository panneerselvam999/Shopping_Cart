...
const Filter = () => {
  ...
  return (
    <section className="mt-5 w-60 rounded-r-lg bg-slate-600 p-3 text-white">
      <div className="rounded-md border-2 border-white p-3">
        <div>
          <h4 className="mb-6 text-xl">Filters:</h4>
        </div>
        <div className="flex flex-col gap-5">
          ...
          <div>
            <button
              className="mx-3 rounded-md bg-slate-400 px-5 py-2"
